...
A tactical, loadout-builder-style meal planning app — plan your week, track nutrition, and generate a consolidated grocery list, all in the browser.
...
_Coming shortly — deploying now._
